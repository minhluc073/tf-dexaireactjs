    ...
    return (
            <section className="vioces-area pt-130 pb-120">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-9 col-lg-10">
                            <div className="section-title-three text-center mb-60 title-animation">
                                <h2 className="title">Check Out Voiceovers Created <span>using DEX.AI</span></h2>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div className="vioces-item">
                                                    ...
                                                    <div className="vioces-content">
                                                        ...
                                                        <ul className="list-wrap">
                                                            <li><Link to="#">Confident</Link></li>
                                                            <li><Link to="#">Bold</Link></li>
                                                            <li><Link to="#">Authoritative</Link></li>
                                                            <li><Link to="#">Bossy</Link></li>
                                                            <li><Link to="#">Charismatic</Link></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-lg-4 col-md-6 col-sm-10">
                                                <div className="vioces-item">
                                                    ...
                                                    <div className="vioces-content">
                                                        ...
                                                        <ul className="list-wrap">
                                                            <li><Link to="#">Bold</Link></li>
                                                            <li><Link to="#">Approachable</Link></li>
                                                            <li><Link to="#">Commanding</Link></li>
                                                            <li><Link to="#">Heroic</Link></li>
                                                            <li><Link to="#">Tough</Link></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-lg-4 col-md-6 col-sm-10">
                                                <div className="vioces-item">
                                                    ...
                                                    <div className="vioces-content">
                                                        ...
                                                        <ul className="list-wrap">
                                                            <li><Link to="#">Reassuring</Link></li>
                                                            <li><Link to="#">Approachable</Link></li>
                                                            <li><Link to="#">Bossy</Link></li>
                                                            <li><Link to="#">Attentive</Link></li>
                                                            <li><Link to="#">Charismatic</Link></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="col-lg-4 col-md-6 col-sm-10">
                                                <div className="more-vioces-item">
                                                    ...
                                                    <div className="more-vioces-content">
                                                        ...
                                                        <Link to="/login" className="gradient-btn gradient-btn-four">TRY NOW FOR FREE</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row justify-content-center">
                                            ...
                                            <div className="col-lg-4 col-md-6 col-sm-10">
                                                <div className="more-vioces-item">
                                                    ...
                                                    <div className="more-vioces-content">
                                                        <p>To get more voices, you can instantly clone any voice with just 3 seconds of audio</p>
                                                        <Link to="/contact" className="gradient-btn gradient-btn-four">TRY NOW FOR FREE</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div className="vioces-shape">
                    <img src="/assets/img/images/voice_shape.png" alt="" className="alltuchtopdown" />
                </div>
            </section>
