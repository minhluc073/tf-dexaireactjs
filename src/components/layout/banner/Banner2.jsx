                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-9 col-lg-10">
                            <div className="banner-content-two">
                                <h2 className="title wow fadeInUp" data-wow-delay=".2s">Create videos from plain &nbsp;
                                    <span>text&nbsp;
                                        <strong>
                                            in minutes
                                ...
                                <p className="wow fadeInUp" data-wow-delay=".4s">DEX.AI is an AI video creation platform. Thousands of companies use it to create videos in 120 languages, saving up to 80% of their time and budget.</p>
                                <div className="banner-btn-two">
                                    <Link to="/work" className="gradient-btn gradient-btn-three wow fadeInLeft" data-wow-delay=".6s">create a free ai video</Link>
                                    <Link to="/work" className="btn btn-three wow fadeInRight" data-wow-delay=".6s">create a free ai video</Link>
                                </div>
                            </div>
                        </div>
                    </div>
