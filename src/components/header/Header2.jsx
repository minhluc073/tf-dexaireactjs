                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="header-top-content text-center">
                                    <p>Sign up and receive 20% bonus discount on checkout. <Link to="/contact">Learn more <i className="far fa-angle-right" /></Link></p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="col-12">
                                ...
                                <div className="menu-wrap">
                                    <nav className="menu-nav">
                                        <div className="logo">
                                            <Link to="/"><img src="/assets/img/logo/logo02.png" alt="Logo" /></Link>
                                        </div>
