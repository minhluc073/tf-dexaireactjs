    ...
    <section class="tools-area pb-140">
                <div class="container">
                    ...
                    <div class="row justify-content-center row-cols-1 row-cols-xl-5 row-cols-lg-3 row-cols-md-3 row-cols-sm-2">
                        <div class="col">
                            <div class="tools-item">
                                ...
                                <div class="tools-content">
                                    <h4 class="title"><Link to="login.html">Social media</Link></h4>
                                    <Link to="login.html" class="link-btn">Select & Try<i class="far fa-arrow-right"></i></Link>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="tools-item">
                                ...
                                <div class="tools-content">
                                    <h4 class="title"><Link to="login.html">Design</Link></h4>
                                    <Link to="login.html" class="link-btn">Select & Try<i class="far fa-arrow-right"></i></Link>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="tools-item">
                                ...
                                <div class="tools-content">
                                    <h4 class="title"><Link to="login.html">Coding</Link></h4>
                                    <Link to="login.html" class="link-btn">Select & Try<i class="far fa-arrow-right"></i></Link>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="tools-item">
                                ...
                                <div class="tools-content">
                                    <h4 class="title"><Link to="login.html">Marketing</Link></h4>
                                    <Link to="login.html" class="link-btn">Select & Try<i class="far fa-arrow-right"></i></Link>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="tools-item">
                                ...
                                <div class="tools-content">
                                    <h4 class="title"><Link to="login.html">SEO</Link></h4>
                                    <Link to="login.html" class="link-btn">Select & Try<i class="far fa-arrow-right"></i></Link>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="more-btn text-center mt-30">
                        <Link to="login.html" class="gradient-btn gradient-btn-two btn-two">more tools & try for free</Link>
                    </div>
                </div>
            </section>
  )
