                                    ...
                                    <div className="col-lg-4 col-sm-6">
                                        <div className="footer-features-item">
                                            ...
                                            <div className="content">
                                                ...
                                                <Link to="/contact">Start using our AI<i className="fal fa-arrow-right" /></Link>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-lg-4 col-sm-6">
                                        <div className="footer-features-item">
                                            ...
                                            <div className="content">
                                                ...
                                                <Link to="/contact">Start free our AI<i className="fal fa-arrow-right" /></Link>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-lg-4 col-sm-6">
                                        <div className="footer-features-item">
                                            ...
                                            <div className="content">
                                                ...
                                                <Link to="/contact">Join our AI<i className="fal fa-arrow-right" /></Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="row row-cols-1 row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2">
                                        ...
                                        <div className="footer-widget">
                                            ...
                                            <div className="footer-link-two">
                                                <ul className="list-wrap">
                                                    ...
                                                    <li><Link to="/contact">AI Research</Link></li>
                                    ...
                                    <div className="col">
                                        <div className="footer-widget">
                                            ...
                                            <div className="footer-link-two">
                                                <ul className="list-wrap">
                                                    <li><Link to="/faq">85+ Video Avatars</Link></li>
                                                    <li><Link to="/faq">120+ Languages</Link></li>
                                                    <li><Link to="/contact">Custom Avatars</Link></li>
                                                    <li><Link to="/contact">Text to Video</Link></li>
                                                    <li><Link to="/contact">Online Video Maker</Link></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="footer-widget">
                                            ...
                                            <div className="footer-link-two">
                                                <ul className="list-wrap">
                                                    ...
                                                    <li><Link to="/contact">Example videos</Link></li>
                                                    <li><Link to="/work">Tools</Link></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col">
                                        <div className="footer-widget">
                                            ...
                                            <div className="footer-link-two">
                                                <ul className="list-wrap">
                                                    <li><Link to="/contact">Training Videos</Link></li>
                                                    <li><Link to="/contact">How-to Videos</Link></li>
                                                    <li><Link to="/contact">Marketing Videos</Link></li>
                                                    <li><Link to="/contact">Service Providers</Link></li>
                                                    <li><Link to="/contact">Product Updates</Link></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col">
                                        <div className="footer-widget">
                                            ...
                                            <div className="footer-contact-two">
                                                <Link to="/tel:0123456789" className="phone">+(1) 123 656 7866</Link>
                                                <Link to="/tel:0123456789" className="phone">+(1) 123 656 7866</Link>
                                                <Link to="/mailto:dex.aiinfotive@.com" className="email">dex.ai infotive@.com</Link>
                                            </div>
